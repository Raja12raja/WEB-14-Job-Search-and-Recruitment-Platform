...
const Create = () => {
  ...
  if (isLoading) {
    return (
      <div className="text-center flex items-center justify-center w-full h-screen text-gray-900">
        <div className="flex items-center justify-center w-full h-full text-gray-900 transform scale-50 mb-40">
          <div>
  ...
  return (
    <div className="flex min-h-screen">
      <div className="w-1/2 flex items-center justify-center ml-10" style={{ position: 'relative' }}>
  <img src={bg} style={{ width: '70%',  }} alt="Background" />
  {/* Content for the left side */}
</div>

      <div className="w-1/2 flex items-center justify-center p-10">
        <div className="max-w-lg w-full bg-white bg-opacity-70 rounded-lg shadow-md mx-5 md:mx-10">
          <h1 className="text-2xl font-bold text-center mb-6">Post a Job</h1>
          <form onSubmit={HandleSubmit} className="flex flex-col gap-4 p-5 text-center">
            ...
            <button
              type="submit"
              className="mt-4 p-3 bg-[#3C5B6F] text-white font-semibold rounded hover:bg-[#393E46] transition duration-200 w-3/4 mx-auto"
            >
              Add Post
            </button>
          </form>
