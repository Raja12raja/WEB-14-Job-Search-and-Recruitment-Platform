        ...
        <div className="p-4 bg-gray-100 min-h-screen">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-10 mt-4 w-full">
                {PendingJobs.length === 0 ? (
                    <div className="col-span-full text-center text-gray-500">No Pending Applications</div>
                ) : (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 mt-4 w-full">
                {AcceptedJobs.length === 0 ? (
                    <div className="col-span-full text-center text-gray-500">No Accepted Applications</div>
                ) : (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 mt-4 w-full">
                {DeclinedJobs.length === 0 ? (
                    <div className="col-span-full text-center text-gray-500">No Declined Applications</div>
                ) : (
