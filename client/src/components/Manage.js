...
const HandleAcc = ()=>{
    ...
    if (isLoading) {
      ...
      if(PendingJobs==""){return (<p>NO APPLICATIONS YET</p>)}
return (
    <div>
...
{/* 2 */}
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-32 mt-4 w-full ">
...
<div class="ml-3">
  ...
  <p class="text-sm text-gray-600">Email : <a>{row.ContactEmail}</a></p>
  
<div className="flex flex-row"> <p class="text-sm text-gray-600">Resume : <a>View</a></p> <button class="absolute right-4 top-4 text-emerald-500 bg-transparent border border-solid border-emerald-500 hover:bg-emerald-500 hover:text-white active:bg-emerald-600 font-bold uppercase text-xs px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 ">Accept</button> </div>  
<div className="flex flex-row"> <p class="text-sm text-gray-600">CV : <a>View</a></p> <button className=" absolute right-4 bottom-3 text-red-500 bg-transparent border border-solid border-red-500 hover:bg-red-500 hover:text-white active:bg-red-600 font-bold uppercase text-xs px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">Reject</button> </div>  
...
<div className="mt-10 bg-slate-100 ">Accepted APPLICATIONS</div>
<div className="mt-10 bg-slate-100">Declined APPLICATIONS</div>
    </div>
)
}
