...
const Footer1 = () => {
  return (
    <footer className="w-full py-3 sm:py-5 px-4 bg-gray-800"> {/* Adjusted padding here */}
      <h2 className="sr-only">Footer</h2>
      <div className="flex flex-col-reverse sm:flex-row md:justify-between lg:justify-around">

        {/* :SITE NAME & SOCIAL NETWORKS */}
        <div className="relative mt-8 sm:mt-0 px-5 flex flex-col justify-center items-center text-gray-500"> {/* Adjusted margin-top here */}
          {/* ::Site name */}
          <h1 className="font-title text-4xl text-center font-semibold mt-auto">Job Search & Recruitment Platform</h1>
          {/* ::Social & copyright */}
          <div className="mt-auto flex flex-col items-center">
            ...
            {/* :::Copyright */}
            <span className="py-2 text-xs">&copy;2024, All Rights Reserved.</span> {/* Adjusted padding here */}
          </div>
        ...
        <div className="grid grid-cols-2 gap-5 text-gray-400">
          ...
          <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4">
            ...
            <nav className="flex justify-around md:flex-col font-medium list-none">
              ...
              <li><a href="#link" className="hover:text-gray-200">Profile</a></li>
              <li><a href="#link" className="hover:text-gray-200">Dashboard</a></li>
              <li><a href="#link" className="hover:text-gray-200">Post a job</a></li>
            </nav>
          </div>
          {/* ::Address */}
          ...
          {/* ::Email */}
          <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4 flex flex-col items-center sm:items-start">
            <h3 className="py-1.5 md:py-4 text-xl text-gray-500 font-bold tracking-wide">Stay Connected</h3>
            <p className="inline-flex justify-center sm:justify-start text-sm text-gray-400 font-medium">
              ...
              <a href="#email">jobsearch@gmail.com</a>
            </p>
          </div>
          {/* ::Phone */}
          <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4 flex flex-col items-center sm:items-start">
